...
namespace WpfAppDP.View
{
    ...
    public partial class WindowEmployee : Window
    {
        ...
        public WindowEmployee(PersonViewModel vmPerson, RoleViewModel vmRole)
        {
            InitializeComponent();
        ...
        private void btnAdd_Click(object sender, RoutedEventArgs e)
        {
            ...
            int maxIdPerson = this.vmPerson.MaxId() + 1;
        ...
        private void btnEdit_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                MessageBox.Show("Необходимо выбрать сотрудника для редактирования",
